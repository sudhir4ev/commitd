...
description:
  'Singtel DLS: design framework and component library for web and mobile — architecture, adoption, and impact.'
date: '2022-05-09'
---
...
serving web and mobile platforms (React-Native), serving as the single source of truth for UI across all consumer-facing
digital products - the main eShop website, dotcom marketing pages, and mobile applications.
...
library for mobile. This is a deliberate architectural boundary. Sharing a single codebase across web and native (such
as via React Native Web) was evaluated and rejected because rendering constraints, accessibility APIs, and platform
idioms diverge enough that a unified abstraction would produce suboptimal components on both platforms.
...
flexibility to compose content without being constrained by what the library author anticipated. It also allows
individual parts (e.g., just Tabs.List) to be used independently.
